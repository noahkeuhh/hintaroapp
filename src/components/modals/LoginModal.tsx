...
export const LoginModal = ({ isOpen, onClose, onSuccess, onSwitchToSignup }: LoginModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.message || "Could not log in. Check your email and password.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link to="/forgot-password" className="text-accent hover:underline" onClick={onClose}>
                  Forgot password?
                </Link>
              </div>
